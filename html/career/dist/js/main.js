...
$(function() {
	$(".a-thumb1").hover(function() {
		$(".p-imgboxa").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
	...
	$(".b-thumb1").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/null.png" alt="" class="mainImage-b img-null">');
	});
	...
	$(".b-thumb2").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_1.jpg" alt="" class="mainImage-b"><div class="change_texbt"><p class="change-text-bg tex-min">岸壁は、ケーソンと呼ばれるコンクリート製の大型の箱を海中に沈めて造ります。</p></div>');
	});
	$(".b-thumb3").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_2.jpg" alt="" class="mainImage-b"><div class="change_texbt"><p class="change-text-bg tex-min">高さが約10mのケーソンを据え付けた岸壁。ケーソンとしては小さめですが、それでも700tもあります。</p></div>');
	});
	$(".b-thumb4").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_3.jpg" alt="" class="mainImage-b"><div class="change_texbt"><p class="change-text-bg tex-min">巨大なケーソンを海中に設置するのに、許される誤差はわすか数センチ。技術力、想像力、経験が問われる現場です。</p></div>');
	});
	$(".b-thumb5").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_4.jpg" alt="" class="mainImage-b"><div class="change_texbt"><p class="change-text-bg tex-min">風や雨、波などの状況が常に変化し、多数の機材を同時に運用する海上での作業には、チームワークが不可欠です。</p></div>');
	});
	$(".b-thumb6").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_5.jpg" alt="" class="mainImage-b"><div class="change_texbt"><p class="change-text-bg tex-min">ケーソンを作る海上ドッグです。ケーソンは巨大なので、海上で作って船で運びます。</p></div>');
	});
	$(".b-thumb7").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_6.jpg" alt="" class="mainImage-b"><div class="change_texbt"><p class="change-text-bg tex-min">ケーソン制作の様子です。木枠で囲いながらコンクリートを流し込み、下から順番に造ります。</p></div>');
	});
	$(".b-thumb8").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p01.jpg" alt="" class="mainImage-b">');
	});//02
	...
	$(".b-thumb2").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_1.jpg" alt="" class="mainImage-b"><div class="change_texb"><p class="change-text-bg tex-min">岸壁は、ケーソンと呼ばれるコンクリート製の大型の箱を海中に沈めて造ります。</p></div>');
	});
	$(".b-thumb3").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_2.jpg" alt="" class="mainImage-b"><div class="change_texb"><p class="change-text-bg tex-min">高さが約10mのケーソンを据え付けた岸壁。ケーソンとしては小さめですが、それでも700tもあります。</p></div>');
	});
	$(".b-thumb4").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_3.jpg" alt="" class="mainImage-b"><div class="change_texb"><p class="change-text-bg tex-min">巨大なケーソンを海中に設置するのに、許される誤差はわすか数センチ。技術力、想像力、経験が問われる現場です。</p></div>');
	});
	$(".b-thumb5").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_4.jpg" alt="" class="mainImage-b"><div class="change_texb"><p class="change-text-bg tex-min">風や雨、波などの状況が常に変化し、多数の機材を同時に運用する海上での作業には、チームワークが不可欠です。</p></div>');
	});
	$(".b-thumb6").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_5.jpg" alt="" class="mainImage-b"><div class="change_texb"><p class="change-text-bg tex-min">ケーソンを作る海上ドッグです。ケーソンは巨大なので、海上で作って船で運びます。</p></div>');
	});
	$(".b-thumb7").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p_1_6.jpg" alt="" class="mainImage-b"><div class="change_texb"><p class="change-text-bg tex-min">ケーソン制作の様子です。木枠で囲いながらコンクリートを流し込み、下から順番に造ります。</p></div>');
	});
	$(".b-thumb8").hover(function() {
	  $(".p-imgboxb").html('<img src="../dist/images/p01.jpg" alt="" class="mainImage-b">');
	});
	...
	$(".c-thumb1").hover(function() {
	  $(".p-imgboxc").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
	...
	$(".d-thumb1").hover(function() {
	  $(".p-imgboxd").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
	...
	$(".e-thumb1").hover(function() {
	 $(".p-imgboxe").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
	...
	$(".f-thumb1").hover(function() {
	  $(".p-imgboxf").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
	...
	$(".g-thumb1").hover(function() {
	  $(".p-imgboxg").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
	...
	$(".h-thumb1").hover(function() {
	  $(".p-imgboxh").html('<img src="../dist/images/null.png" alt="" class="mainImage-a img-null">');
	});
