...
// 本文を設定
$admin_reply_text = "下記の内容でお問い合わせがありました。（中途採用）\n\n";
$admin_reply_text .= "お問い合わせ日時：" . date("Y-m-d H:i") . "\n";
$admin_reply_text .= "氏名：" . $clean['name'] . "\n";
$admin_reply_text .= "かな：" . $clean['furigana'] . "\n";
...
<head>
  ...
  <title>大旺新洋株式会社｜採用情報｜中途採用</title>
      ...
      <div class="s-container">
            ...
            <div class="s-main-inner">
              ...
              <div class="tex-p_1 sub-4pb">
                ...
                <p id="contact" class="main-subtitle sub-4mb_mail sub-4mt">メールでのお問い合わせ</p>
                  ...
                  <form method="post" action="" id="flag1" class="health-wrap contact-modal ContactInput check-wrap-r-mid">
        ...
        <div class="wrap">
          <div class="flex-row-md">
              <p class="w-wrap f-inner f-img"><a href="../index.html">大旺新洋TOP</a></p>
