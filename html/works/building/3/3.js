...
(lib._3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({alpha:1},0).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({alpha:1},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({alpha:1},0).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({alpha:1},0).wait(18));
