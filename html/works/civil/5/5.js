...
(lib._5 = function(mode,startPosition,loop) {
	...
	this.instance_1.setTransform(190,280,1,1,0,0,0,0,140);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regY:0,y:140},0).wait(23).to({scaleY:0.9917,y:141.1667},0).wait(1).to({scaleY:0.9833,y:142.3333},0).wait(1).to({scaleY:0.975,y:143.5},0).wait(1).to({scaleY:0.9833,y:142.3333},0).wait(1).to({scaleY:0.9917,y:141.1667},0).wait(1).to({scaleY:1,y:140},0).wait(1).to({scaleY:0.9917,y:141.1667},0).wait(1).to({scaleY:0.9833,y:142.3333},0).wait(1).to({scaleY:0.975,y:143.5},0).wait(1).to({scaleY:0.9833,y:142.3333},0).wait(1).to({scaleY:0.9917,y:141.1667},0).wait(1).to({scaleY:1,y:140},0).wait(1));

	// レイヤー_3
	this.instance_2 = new lib._1b_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(190,140);
	this.instance_2.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({alpha:1},0).wait(6).to({alpha:0},0).wait(6).to({alpha:1},0).wait(6).to({alpha:0},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({alpha:0},0).wait(6).to({alpha:1},0).wait(6).to({alpha:0},0).wait(6).to({alpha:1},0).wait(12));
