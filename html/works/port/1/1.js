...
(lib._1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(36).to({alpha:1},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(24).to({alpha:1},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({alpha:1},0).wait(36));
