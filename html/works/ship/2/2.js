...
(lib._2 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(12).to({alpha:0},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(12).to({y:134},0).wait(1).to({y:139},0).wait(1).to({y:144},0).wait(1).to({y:141},0).wait(1).to({y:138},0).wait(1).to({y:139.5},0).wait(1).to({y:141},0).wait(1).to({y:140},0).wait(1).to({y:139},0).wait(1).to({y:139.5},0).wait(1).to({y:140},0).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({alpha:1},0).wait(24));
...
p.nominalBounds = new cjs.Rectangle(190,134,190,150);
// library properties:
lib.properties = {
