...
lib.ssMetadata = [
		...
		{name:"3_atlas_7", frames: [[0,0,380,280]]}
];
...
(lib._3 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(24).to({alpha:1},0).wait(12).to({alpha:0},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({alpha:1},0).wait(12).to({alpha:0},0).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({alpha:0},0).wait(36).to({alpha:1},0).wait(12));
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/3_atlas_7.png", id:"3_atlas_7"}
	],
	preloads: []
};
