...
(lib._5 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(24).to({alpha:1},0).wait(6).to({alpha:0},0).wait(6).to({alpha:1},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(30).to({alpha:1},0).wait(6).to({alpha:0},0).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({alpha:0},0).wait(6).to({alpha:1},0).wait(6).to({alpha:0},0).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(12).to({alpha:1},0).wait(6).to({alpha:0},0).wait(30));
